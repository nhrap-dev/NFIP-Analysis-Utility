...
t1 =time()
shp = gpd.read_file(r'C:\projects\Barry\NFIP.shp')
print(time() - t1)

print('mosaicking rasters')
t1 = time()
raster_files = [r'C:/0808peak_flood_depthft_bin.tiff',
    r'C:/0809peak_flood_depthft_bin.tiff']
...
try:
    pivot_coverage.to_excel(r'C:/pivot_coverage.xlsx')
    pivot_policies.to_excel(r'C:/pivot_policies.xlsx')
except:
    pivot_coverage.to_csv(r'C:/pivot_coverage.csv')
    pivot_policies.to_csv(r'C:/pivot_policies.csv')
print(time() - t1)
