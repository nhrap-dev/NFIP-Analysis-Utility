def NFIP_PNNL(depth_grids, NFIP_points, out_folder):
    """ Calculates coverage and policies by flood depth
        ...
        Keyword arguments:
        depth_grids: array<string> -- array of file path names to the depth grid rasters
        NFIP_points: string -- Shapefile containing the NFIP points. Must contain fields: LOW_FLOOR, LOWADJ_GRA, T_COV_BLDG, T_COV_CONT, POL_NO, STATEFP and NAME 
        out_folder: string -- file path name to directory for outputs
    """
    # imports 
