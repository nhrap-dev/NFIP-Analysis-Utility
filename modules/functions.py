def AnalyzeNFIP(depth_grids, NFIP_points, out_folder, export_shapefile=False):
    ...
    if type(extract) == list:
        ...
        depths = np.maximum.reduce(extract)
        print(time() - t1)
    ...
    print(time() - t1)
    if export_shapefile != 0:
        print('Exporting spatial output')
        t1 = time()
        gdf.to_file(out_folder + '/' + "NFIP_Analysis.shp", driver='ESRI Shapefile')
        print(time() - t1)
...
# AnalyzeNFIP(r'C:\Users\jrainesi\Downloads\test/cera.shp', r'C:\Users\jrainesi\Downloads\test/nfip.shp', r'C:\Users\jrainesi\Downloads\test', export_shapefile=0)

# depth_grids = [r'C:\projects\Disasters\Dorian\Data\PNNL\RIFT20190904_00z_raster/' + x for x in os.listdir(r'C:\projects\Disasters\Dorian\Data\PNNL\RIFT20190904_00z_raster') if x.endswith('tiff')]
# NFIP_points = r'C:\projects\Disasters\Dorian\Data\NFIP\Dorian_NFIP_CERA_elevs_0s9012019/Dorian_NFIP_CERA_elevs_09012019.shp'
# out_folder = r'C:\projects\Disasters\Dorian\outputs\NFIP_20190904'
